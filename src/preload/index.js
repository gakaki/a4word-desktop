...
const dict = {
	...
	saveDict: (ids, fileName, intro, dictIds, classId) =>
		ipcRenderer.invoke("saveDict", { ids, fileName, intro, dictIds, classId }),
...
const word = {
	...
	listLearnByDictId: (params) =>
		ipcRenderer.invoke("listLearnByDictId", { params }),
	fetchContentByWordId: (params) =>
		ipcRenderer.invoke("fetchContentByWordId", { params }),
	...
	listReviewByDictId: (params) =>
		ipcRenderer.invoke("listReviewByDictId", { params }),
	increReviewCycle: (id, cycle) =>
		ipcRenderer.invoke("increReviewCycle", { id, cycle }),
	listByDictId: (params) => ipcRenderer.invoke("listByDictId", { params }),
	listLikeByDictId: (params) =>
		ipcRenderer.invoke("listLikeByDictId", { params }),
	listAllByDictId: (params) =>
		ipcRenderer.invoke("listAllByDictId", { params }),
	listCompleteByDictId: (params) =>
		ipcRenderer.invoke("listCompleteByDictId", { params }),
